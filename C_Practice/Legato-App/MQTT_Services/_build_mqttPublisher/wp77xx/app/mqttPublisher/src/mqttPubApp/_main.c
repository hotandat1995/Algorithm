...
// Startup code for the executable 'mqttPubApp'.
...
LE_SHARED const char* _mqttPublisherComponent_mqttSer_ServiceInstanceName = "mqttPubApp.mqttPublisherComponent.mqttSer";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t mqttPubApp_exe_LogSession;
LE_SHARED le_log_Level_t* mqttPubApp_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    mqttPubApp_exe_LogSession = le_log_RegComponent("mqttPubApp_exe", &mqttPubApp_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_mqttPublisherComponent.so");
