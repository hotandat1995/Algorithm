  ...
  unsigned char sessionPresent)
{
  int strindex = snprintf(strbuf,
                          strbuflen,
                          "CONNACK session present %d, rc %d",
                          sessionPresent,
                          connack_rc);
  return strindex;
}

int MQTTStringFormat_publish(
  char *strbuf,
  int strbuflen,
  unsigned char dup,
  int qos,
...
int MQTTStringFormat_subscribe(
  char *strbuf,
  int strbuflen,
  unsigned char dup,
  unsigned short packetid,
...
int MQTTStringFormat_unsubscribe(
  char *strbuf,
  int strbuflen,
  unsigned char dup,
  unsigned short packetid,
  ...
  int buflen)
{
  ...
  case SUBSCRIBE:
  {
    ...
    int requestedQoSs[1];
    if (MQTTDeserialize_subscribe(&dup,
                                  &packetid,
                                  maxcount,
                                  &count,
                                  topicFilters,
                                  ...
                                  buf,
                                  buflen) == 1)
      strindex = MQTTStringFormat_subscribe(strbuf,
                                            strbuflen,
                                            dup,
                                            packetid,
                                            count,
  ...
  case UNSUBSCRIBE:
  {
    ...
    int maxcount = 1, count = 0;
    MQTTString topicFilters[1];
    if (MQTTDeserialize_unsubscribe(&dup,
                                    &packetid,
                                    maxcount,
                                    &count,
                                    topicFilters,
                                    ...
                                    buflen) == 1)
    {
      strindex = MQTTStringFormat_unsubscribe(strbuf,
                                              strbuflen,
                                              dup,
                                              packetid,
                                              count,
